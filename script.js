...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    function applyColorEngine(color) {
        ...
        style.innerHTML = `
            ...
            /* YENİ: KUSURSUZ CANLI ARAMA STİLLERİ */
    ...
    async function initializeSystem() {
        ...
        if (document.getElementById("allProductGrid")) {
            fetchAllProducts();
        }
    }
    ...
    if (searchInput) {
        ...
        const mainNavbar = document.querySelector(".navbar"); // Navbar'ın kendisi
        ...
        overlay.style.zIndex = '99990'; // Arama kutusundan düşük olmalı
        ...
        function openSpotlight() {
            ...
            // Arama Kutusunu Karartmanın Üstüne Çıkar! (Z-Index: 99999)
            searchInput.style.position = 'relative';
            searchInput.style.zIndex = '99999';
            searchInput.style.backgroundColor = '#fff';
            searchInput.style.color = '#000';

            // Kutusunu (Parent) da üste çek ki karanlığa gömülmesin
            if(searchContainer) {
                searchContainer.style.position = 'relative';
                searchContainer.style.zIndex = '99999';
            }

            // Navbar'ı da üste çekiyoruz ki kutu içinde kesilmesin
            if(mainNavbar) {
        ...
        function closeSearch() {
            ...
            if(mainNavbar) {
                mainNavbar.style.zIndex = '1030'; // Navbarın orjinal boostrap z-index'ine dön
            }
